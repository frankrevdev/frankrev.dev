...
function _ccc(t, i) {
    ...
    var e = function() {
            ...
            return _cc(t, [{
                ...
                value: function(t) {
                    var i = this.srpiq();
                    return 3 === t ? (this.x = i.x + i.halfWidth, void(this.y = i.y)) : 2 === t ? (this.x = i.x, void(this.y = i.y + i.halfHeight)) : 1 === t ? (this.x = i.x + i.halfWidth, void(this.y = i.y + i.halfHeight)) : (this.x = i.x, void(this.y = i.y))
                }
            }, {
                key: "srpiq",
                value: function() {
                ...
                value: function(t, s, e) {
                    this.o.size.pulse && (this.s += this.o.size.pulse * this.d, (this.s > this.o.size.max || this.s < this.o.size.min) && (this.d *= -1), this.s = Math.abs(this.s)), this.x += this.vx, this.y += this.vy, this.x < 0 ? (this.vx *= -1, this.x += 1) : this.x > s && (this.vx *= -1, this.x -= 1), this.y < 0 ? (this.vy *= -1, this.y += 1) : this.y > e && (this.vy *= -1, this.y -= 1), t.beginPath(), this.o.blending && "none" !== this.o.blending && (t.globalCompositeOperation = this.o.blending);
        ...
        h = function() {
            function h(i) {
                ...
                }), !1), this.init(i), this.lastFrame = 0, t.requestAnimationFrame(this.an.bind(this))
            }
            return _cc(h, [{
                key: "gr",
                value: function(t) {
